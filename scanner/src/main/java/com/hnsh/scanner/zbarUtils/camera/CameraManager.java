...
package com.hnsh.scanner.zbarUtils.camera;
...
import com.hnsh.scanner.zbarUtils.camera.open.OpenCameraInterface;
...
public class CameraManager {
    ...
    public synchronized void openDriver(SurfaceHolder holder)
        ...
        try {
            ...
            Log.e(TAG, "Resetting to saved camera params: "
                    + parametersFlattened);
            // Reset:
     ...
     * @param cropRect
     */
    public void reSetFocusRect(Rect cropRect) {
//
//        Parameters parameters = camera.getParameters();
//        Rect focusRect = cropRect;
//        Rect meteringRect = cropRect;
//
//        if (parameters.getMaxNumFocusAreas() > 0) {
//            List<Camera.Area> focusAreas = new ArrayList<>();
//            focusAreas.add(new Camera.Area(focusRect, 600));
//            parameters.setFocusAreas(focusAreas);
//            DebugLog.i("setFocusAreas===============>focusAreas");
//        }
////        if (parameters.getMaxNumMeteringAreas() > 0) {
////            List<Camera.Area> meteringAreas = new ArrayList<>();
////            meteringAreas.add(new Camera.Area(meteringRect, 600));
////            parameters.setMeteringAreas(meteringAreas);
////            DebugLog.i("setFocusAreas===============>meteringRect");
////        }
//
