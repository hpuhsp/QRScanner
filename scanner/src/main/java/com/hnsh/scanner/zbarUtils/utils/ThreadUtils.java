...
public final class ThreadUtils {
    ...
    public abstract static class Task<T> implements Runnable {
        ...
        private Task.OnTimeoutListener mTimeoutListener;
         ...
         */
        public Task<T> setTimeout(final long timeoutMillis, final Task.OnTimeoutListener listener) {
